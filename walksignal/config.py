    ...
    def __init__(self, filename):
        ...
        try:
            with open(self.filename) as stream:
                ...
                self.pl_exp_value = self.data.get("pl_exp", 1)
                self.pl_exp_tworay_value = self.data.get("pl_exp_tworay", 1)
                self.pl_ref_dist_value = self.data.get("pl_ref_dist", 1)
                self.pl_ref_pl_value = self.data.get("pl_ref_pl", 80)
                self.pl_ref_freq_value = self.data.get("pl_ref_freq_value", 1000)
